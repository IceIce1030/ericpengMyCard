...
const data = {
  ...
  cakeresume:
    chalk.gray('https://www.cakeresume.com/resumes/') +
    chalk.cyan('elric-peng/'),
  facebook:
    chalk.gray('https://www.facebook.com/profile.php') +
    chalk.cyan('?id=100000365605891&ref=bookmarks'),
  web: chalk.cyan('http://www.ericpen.com/'),
...
const output =
  ...
  cakeresume +
  newline + // data.labelCakeresume + data.cakeresume
  facebook +
